...
cur_free_space = 70000000 - directories["/"]
need = 30000000 - cur_free_space

part2_size = math.inf
part2 = None

print(cur_free_space)
for cur_dir in directories:
    if directories[cur_dir] >= need:
        if directories[cur_dir] < part2_size:
            part2_size = directories[cur_dir]

print("part2 = " + str(part2_size))